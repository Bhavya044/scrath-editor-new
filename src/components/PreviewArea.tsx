...
import CatSprite, { CatSpriteProps } from "./CatSprite";
...
const PreviewArea: React.FC = () => {
    ...
    const handleDrop = (e: React.DragEvent<HTMLDivElement>) => {
        ...
        if (draggingCatId) {
            const catElement = document.querySelector(`#${draggingCatId}`) as HTMLElement;
            if (catElement) {
